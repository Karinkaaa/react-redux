...
const LayerTableHead = ({ sorting, filters, onChangeSort, onChangeFilterValue }) => {
    ...
    return (
        <Grid container className={classes.head}>
            ...
            <Grid item xs={6} className={classes.headCell} style={{ paddingLeft: 20 }}>
                Description
            </Grid>
        </Grid>
    );

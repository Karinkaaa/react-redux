...
const MusicTableHead = ({ sorting, onChangeMusicSort, onChangeMusicFilterValue }) => {
        ...
        <Grid container className={classes.head}>
            ...
            <Grid item xs={2} className={classes.headCell}>
                ...
                <div className={classes.filter}>
                    ...
                    <InputBase
                        ...
                        onChange={(e) => onChangeMusicFilterValue({
                            filterKey: "id",
            ...
            <Grid item xs={3} className={classes.headCell}>
                <TableSortLabel
                    active={field === "name"}
                    direction={direction}
                    onClick={() => onChangeMusicSort("name")}
                    className={classes.sortLabel}
                >
                    Name
                </TableSortLabel>
